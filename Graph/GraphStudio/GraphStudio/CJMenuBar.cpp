 ...
 * $Date: 6/23/99 12:04a $
 * $Revision: 7 $
 * $Archive: /CodeJockey/CJLibrary/CJMenuBar.cpp $
 *
...
//
void CCJMenuBar::SetTrackingState(enum TRACKINGSTATE iState, int iButton)
{
	ASSERT_VALID(this);
...
void CCJMenuBar::TrackPopup(int iButton)
{
	...
	int nMenuItems = m_popupMenu.GetMenuItemCount();
