...
Point3D BaShou[32];
Point3D BaShou2[32];
void Line(CDC& dc,Point3D& x,Point3D& y);
int count=0;
////////////////////////////////////////////////////////////////////////////
// CChildView
...
void Line(CDC& dc,Point3D& x,Point3D& y)
{
	dc.MoveTo((int)(400-x.x*100),(int)(400-x.y*100));
	dc.LineTo((int)(400-y.x*100),(int)(400-y.y*100));
}

void CChildView::Bazel(CDC& dc,Point3D* point,int size,int n,void(*p)(CDC&,Point3D&))
{
	if(size!=4)
...
void CChildView::BazelEx(CDC& dc,Point3D* point,int size,int n,void(*p)(CDC&,Point3D&))
{
	int x,y,i;
	if(size!=16)
		TRACE("Warning: not supported\n");
