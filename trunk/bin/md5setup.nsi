...
OutFile "MD5Setup.exe"
InstallDir "$PROGRAMFILES\EasyMD5"
InstallDirRegKey HKLM "${PRODUCT_DIR_REGKEY}" ""
ShowInstDetails show
ShowUnInstDetails show
Icon  "..\wmd5\res\wmd5.ico"
UninstallIcon  "..\wmd5\res\wmd5.ico"
Function .onInit
...
; CreateShortCut "$SMPROGRAMS\EasyMD5\EasyMD5.lnk" "$INSTDIR\wmd5.exe"
; CreateShortCut "$DESKTOP\EasyMD5.lnk" "$INSTDIR\wmd5.exe"
  File "ctxmenu.dll"
  File "license.txt"
SectionEnd
...
;  Delete "$DESKTOP\EasyMD5.lnk"
;  Delete "$SMPROGRAMS\EasyMD5\EasyMD5.lnk"
